...
# -Activation de la variable d'environement

# -Pour ne pas exposer notre mot de passe directement dans le code, nous installons la 
#bibliothèque python-dotenv pour charger nos variables d'environnement à partir d'un fichier .env.
    ## Installation de python-dotenv avec la commande:
    pip install python-dotenv
    ## Création d'un fichier .env à la raçine du projet dans lequel on ajtoute nos variables d'environnement
