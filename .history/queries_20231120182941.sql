...
--d savoir combien coûte en moyenne chaque voiture dans chaque pays selon le type de moteur.
SELECT Country, EngineType, AVG(SalesVolume) AS Moyenne_Cout
FROM consumer
GROUP BY Country, EngineType;

--e évaluations moyennes des voitures électriques par rapport aux voitures thermiques.
